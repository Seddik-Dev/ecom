...
export default function AdminNavbar({ onToggleSidebar }) {
  ...
  return (
    <header className="flex items-center justify-between h-16 px-5 bg-white border-b border-gray-200 sticky top-0 z-30">
      <div className="flex items-center gap-3 flex-1 max-w-md">
        ...
        <div className="flex items-center gap-2 w-full px-3 py-2 rounded-lg border border-gray-200 text-gray-400 focus-within:border-violet-400 transition-colors">
          <Search size={17} />
          <input
            placeholder="Search"
